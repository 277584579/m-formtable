  ...
  <Input v-model="dataValue" :placeholder="placeholder" :disabled="disabled" @on-blur="onBlur" />
   <div class="icon" @click="checkEdit" :class="disabled?'disabled':''">
    ...
    <PopUp ref="popUp"  :show="showStatus" :title="title" :size="'large'" @editShowStatus="editShowStatus"> 
      ...
      <Formtable :operationArr="operationArr" :datalistTable="datalistTable" :dataListArr="dataListArr" :columnListArr="columnListArr"></Formtable>
    </PopUp>
</div>
</template>
<script lang="ts">
...
// import {datalistTable,datalistTable1,dataListArr,buttonListArr,statusListArr,columnListArr,columnListArr1,checkListArr,checkListArr1} from "../../../../examples/mock"
